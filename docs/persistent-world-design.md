...
- How long does a road / port / fortification level take to complete — one tick, or several?
...
- **[OPEN]** Casus belli: required / soft / none. Soft-CB recommendation still on the table — war without a justification is possible but costs Trust and spikes unrest in Peaceful/Isolationist territories. With a 5-friend group that self-polices via Discord this may be unnecessary overhead; decide before building.
...
### 9.9 Raiding wars [DECIDED — recommended in]
A war may be fought with **no intent to take land** — purely to extract Wealth/tribute via the peace deal. This gives weaker nations a way to be threatening without conquest. **[OPEN]** confirm and define raid mechanics.

### [OPEN] War — remaining numbers
- Casus belli: required / soft / none.
- Amphibious penalty values.
