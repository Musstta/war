...
const start = async () => {
  ...
  // NOTE: /api/action, /api/diplomacy, /api/war/:warId/council, /api/world removed in v0.39.
  // NOTE: /admin/tick, /admin/set-phase, /admin/reset-world (no /api/ prefix) removed in v0.39.
  // NOTE: /api/admin/tick, /api/admin/set-phase, /api/admin/reset-world, /api/admin/world-full removed in v0.39.
  // All game-state routes are now scoped: /api/admin/games/:gameId/* and /api/dev/games/:gameId/*.
